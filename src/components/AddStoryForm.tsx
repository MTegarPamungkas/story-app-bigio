...
interface AddStoryFormProps {
  onSubmit: (storyData: { story: Story; chapters: Chapter[] }) => void;
}

const AddStoryForm: React.FC<AddStoryFormProps> = ({ onSubmit }) => {
  ...
  const handleSubmit = () => {
    const storyData: { story: Story; chapters: Chapter[] } = {
      story: {
        title,
        writer,
        synopsis,
